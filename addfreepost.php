        ...
        <html>
            ...
            <body>
               <div class="max-w-sm mx-auto bg-gray-400 px-5 py-10 rounded shadow-xl">
                <form action="addprocess_free.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="submit" class="px-7 py-1 text-lg text-white border rounded border-gray-800 bg-blue-600 hover:bg-blue-700" value="Free Post">
